...
const ProfileSection = () => {
  return (
    <div className="flex flex-col items-center text-center gap-3 pt-12 pb-2">
      {/* === Step 1. アイコンを表示させる */}
      <Avatar iconPath={iconImage} initials="TG" size={100} />

      {/* === Step 2. 自分の名前、所属、一言を表示させる === */}
      {/* 💡自分の情報に書き換えよう */}

      <div className="mt-2">
        <span className="text-2xl font-bold text-[#3a3028] m-0">
          がーすー３
        </span>
        <p className="text-sm text-[#8a7a6c] mt-0.5">Ga-su-san</p>
      </div>
      <p className="text-sm text-[#6b5744]"> MJ大学　情報工学部　B1</p>
      <p className="text-xs text-[#8a7a6c]">📍 愛知</p>
